...
Note: hledger does not currently report asset values based on current stock prices, but this functionality is planned for a future release.  ledger-cli does incluede this functionality and the prices generated by hledger-quotes can be used hledger-cli.
